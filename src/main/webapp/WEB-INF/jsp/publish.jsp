...
<div class="container">
    <div class="card">
        <h2 style="color:#667eea;margin-bottom:20px;">发布信息</h2>
        ...
        <form action="${pageContext.request.contextPath}/publish" method="post" enctype="multipart/form-data">
            <div class="form-group">
                ...
                <select name="type" required>
                    ...
                    <option value="found">寻物启事</option>
                </select>
            </div>
            <div class="form-group">
                <label>标题</label>
            ...
            <div class="form-group">
                <label>详细描述</label>
                <textarea name="content" placeholder="请详细描述物品特征、丢失/捡到地点等信息" required></textarea>
            </div>
            <div class="form-group">
                <label>联系方式</label>
                <input type="text" name="contact" placeholder="QQ/微信/电话等" required>
            </div>
            <div class="form-group">
                <label>上传图片（可选）</label>
            ...
            <div class="form-group">
                <button type="submit" class="btn-submit">发 布</button>
            </div>
        </form>
    </div>
</div>
